...
background:white;
 ...
 <link type="text/css" href="../cpe/menu.css" rel="stylesheet" />

      <link rel="stylesheet" href="../cpe/css/style-newsticker.css" type="text/css" media="screen" />

  <script src="../cpe/js/jquery-1.5.2.min.js" type="text/javascript"></script>
<script src="../cpe/js/jcarousellite_1.0.1c4.js" type="text/javascript"></script>
...
$(function() {
  $.noConflict();
    ...
    <script type='text/javascript' src='../cpe/jquery-1.4.2.min.js'></script>

<script type='text/javascript' src='../cpe/slotmachine.js'></script>




    <script type="text/javascript" src="../cpe/js/jquery.js"></script>
    ...
    <!-- include jQuery and Contact-Pop scripts -->
      <link rel="stylesheet" type="text/css" href="../cpe/css/contact-pop.css" />
<script type="text/javascript" src="../cpe/js/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="../cpe/js/contact-pop.js"></script>
...
<script type="text/javascript" src="../cpe/jquery/fadeSlideShow.js"></script>
...
<script type="text/javascript" src="../cpe/undergraduate/js/jquery-1.5.2.min.js"></script>
