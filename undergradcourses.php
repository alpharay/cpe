	...
	<div class="curvedContainer">
		...
		<div class="tabcontent" id="tab_content_2">
			...
			<strong>Level 400 Courses</strong> <BR><BR>
                        ...
                        $tableData = array($firstRow, $secondRow, $thirdRow, $fourthRow,$fifthRow,$sixthRow,$seventhRow,$eighthRow,$ninthRow,$tenthRow,$eleventhRow,$twelvethRow,$thirtheenthRow,$fourtheenthRow,$totalRow);
                        $tableTester->generateTable16(array('Course', 'Course Name', 'Credit'), $tableData);
