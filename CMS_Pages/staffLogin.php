...
div#copyright a:hover { color:#fff; }
    ...
    <body>        
        ...
        */
        ...
        if((isset($_SESSION['authentic']))&&($_SESSION['authentic']==true))header("location: staffBase.php");

        
        //CREATING THE SIDE MENU
        $sideMenu= new SideMenuCreator('../Tools/images/news-arrow-previous.png');
        $sideMenu->addToSideMenu("LEVEL 400 PROJECT", "http://www.scriptbreaker.com", "Progress Presentation", "Date:10/02/2012,Venue:FES");
        ...
        <div id = "slide">
            <ul id="slideshow">
                ...
                <li><img src="images/img3.jpg" width="776" height="587" border="0" alt="" /></li-->                
                        ...
                        <form  action="staffLogin.php" method="post"><br/><br/><br/> 
                            <?php
                            if($userGenuine==false){
                                echo "<b style='color:#8D0D19; margin-left:150px;'>Wrong Login Info</b>";
                                echo "<br/><br/>";
                                }
                           //if(isset($_GET['autoLgID'])&&($_GET['autoLgID']==77))
                            if(isset($_SESSION['autoLgID'])&&($_SESSION['autoLgID']==77)) 
                            {                                
                                echo "<b style='color:#8D0D19; margin-left:80px;'>Session Time Expired; Please Login again</b>";
                                echo "<br/><br/>";                              
                               session_destroy();
                            }
                            ?>                            
                            <legend style="margin-left:170px;"><b>STAFF LOGIN</b></legend><br/>
                                <b style="margin-left:90px;">Staff ID </b><input name="username" type="textbox" style="background-color: lightblue;height: 30px;"/><br/><br/>
                                <b style="margin-left:76px;">Password</b><input name="password" type="password" style="background-color: lightblue;height: 30px;margin-left:6px;"/><br/><br/>
