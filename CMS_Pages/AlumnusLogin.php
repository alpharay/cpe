...
div#copyright a:hover { color:#fff; }
    ...
    <body>        
       ...
       //Home
        ...
        $userGenuine=$staffAuthenticate->staffAuthenticate($username,$password,"AlumnusBase.php");
        }
        ...
        <div id = "slide">
            <ul id="slideshow">
                ...
                <li><img src="images/img3.jpg" width="776" height="587" border="0" alt="" /></li-->                
                        ...
                        <form  action="AlumnusLogin.php" method="post"><br/><br/><br/> 
                             <?php
                           ...
                           //if(isset($_GET['autoLgID'])&&($_GET['autoLgID']==77))
                            ...
                            ?> 
                            <legend style="margin-left:170px;"><b>ALUMNUS LOGIN</b></legend><br/>
                                <b style="margin-left:50px;">Username</b><input name="username" type="textbox" style="background-color: lightblue;height: 30px;"/><br/><br/>
                                <b style="margin-left:50px;">Password</b><input name="password" type="password" style="background-color: lightblue;height: 30px;margin-left:6px;"/><br/><br/>
