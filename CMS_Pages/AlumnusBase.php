...
div#copyright a:hover { color:#fff; }
    ...
    <body>        
       ...
       if($_SESSION['authentic']==true){ 
        ...
        echo "&nbsp&nbsp&nbsp<input type='submit' name='submit' value='EDIT' style='width:100px; color:blue'/>";
        echo "&nbsp&nbsp<input type='submit' name='submit' value='CONFIRM' style='width:100px; color:blue'/>";
        echo "<br><br>";        
